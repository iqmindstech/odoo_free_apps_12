...
class PaymentAcquirerPaycap(models.Model):
    ...
    provider = fields.Selection(selection_add=[('paycaps', 'Paycaps')])
    ...
    def _get_paycaps_urls(self,environment):
        """ PayUmoney URLs"""
        if environment == 'prod':
    ...
    def paycaps_get_form_action_url(self):
        return self._get_paycaps_urls(self.environment)['paycaps_form_url']
